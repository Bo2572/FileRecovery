...
import com.filerecovery.photorecovery.model.modul.recoveryvideo.adapter.AlbumsVideoAdapter;
...
public class AlbumVideoActivity extends AppCompatActivity implements AlbumsVideoAdapter.OnClickItemListener {
    ...
    public void intData() {
        this.adapter = new AlbumsVideoAdapter(this, MainActivity.mAlbumVideo, this);
